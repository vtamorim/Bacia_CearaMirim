  ...
  <div class="page-inner">
    <div class="contact-wrapper">
      <form class="contact-form" @submit.prevent="enviarContato">
        ...
        <div class="feedback">
          <p v-if="status === 'enviando'" class="enviando">
            Enviando mensagem...
          </p>
          <p v-if="status === 'sucesso'" class="sucesso">
            {{ mensagemStatus }}
          </p>
...
const enviarContato = async () => {
  // Validação básica
  if (!pri_nome.value.trim()) {
    status.value = 'erro';
    mensagemStatus.value = 'Por favor, insira seu primeiro nome.';
    return;
  }
  if (!email.value.trim() || !/\S+@\S+\.\S+/.test(email.value)) {
    status.value = 'erro';
    mensagemStatus.value = 'Por favor, insira um e-mail válido.';
    return;
  }
  if (!mensagem.value.trim()) {
    status.value = 'erro';
    mensagemStatus.value = 'Por favor, insira uma mensagem.';
    return;
  }

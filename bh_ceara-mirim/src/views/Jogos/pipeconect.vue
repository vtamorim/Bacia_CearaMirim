  ...
  <div class="game-page">
    ...
    <div class="game-content">
      <section class="game-description">
        <h2>Como Jogar</h2>
        <p>
          A água precisa fluir do topo (esquerda) até a saída (direita/fundo).
        </p>
        <p>
          Clique nos blocos para <strong>girar os canos</strong>. Tente fazer
      ...
      <section class="game-area">
        <div class="pipe-game-container">
          <div class="game-stats">
            <span
              >Movimentos: <strong>{{ moves }}</strong></span
            >
          </div>
          ...
          <div class="board-wrapper">
            <div class="connector start">
              <div class="pipe-stub">
                <div
                  class="water-flow"
                  :class="{ active: flatGrid[0]?.filled }"
                ></div>
              </div>
            </div>
...
.connector.start .pipe-stub {
  border-radius: 4px 4px 0 0;
  border-top: 5px solid #468e28;
}
.connector.end .pipe-stub {
  border-radius: 0 0 4px 4px;
  border-bottom: 5px solid #468e28;
}
...
.game-info {
  ...
  grid-template-columns: repeat(
    3,
    1fr
  ); /* Força 3 colunas para ficar compacto */
  gap: 1rem;
  padding: 0;

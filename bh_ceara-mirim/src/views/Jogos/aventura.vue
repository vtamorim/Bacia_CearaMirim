  ...
  <div class="game-page">
    ...
    <div class="game-content">
      <section class="game-description">
        <h2>Como Jogar</h2>
        <p>
          Neste jogo, você terá que passar por obstáculos e descobrir
          informações sobre a Bacia Cearamirim.
        </p>
        <p v-if="!isMobile">
          Teclas: <strong>WASD</strong> para mover, <strong>Espaço</strong> para
          pular.
        </p>
        <p v-else>
          Toque: Use o <strong>D-Pad</strong> para mover e o botão
          <strong>Pular</strong>.
        </p>
      </section>
        ...
        <div class="unity-container"  >
          ...
          <div class="game-actions">
            <button @click="toggleFullscreen" class="fullscreen-btn">
              <span>⛶</span>
              {{ isMobile ? 'Expandir / Tela Cheia' : 'Jogar em Tela Cheia' }}
            </button>
          </div>
        </div>
      </section>

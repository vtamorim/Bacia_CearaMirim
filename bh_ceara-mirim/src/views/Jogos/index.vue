    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <div class="modal-game-info">
          ...
          >
            <img
              :src="selectedGame.emoji"
              alt="imagem do jogo"
              v-if="selectedGame.emoji"
              class="imagem_jogo"
            />
          </div>
          ...
          <button class="play-button" @click="playGame">Jogar Agora</button>
        </div>
      </div>
    </div>
  </section>
...
const games = [
  {
    ...
    fullDescription:
      'Uma jornada em que o jogador precisa pecorrer e superar obstáculos e plataformas para que possa ter uma grande vitória no final.',
  ...
  },
  {
    ...
    fullDescription:
      'Teste sua memória combinando pares de cartas relacionadas à Bacia Ceara-mirím e à preservação dos recursos hídricos.',
    emoji: foto_memoria,
    color: capa_memoria,
    difficulty: 'Médio',
    duration: '10 min',
  ...
  },
  {
    ...
    fullDescription:
      'Perguntas para testar o seu conhecimento sobre a Bacia Ceara-mirím e a importância da preservação dos recursos hídricos.',
    emoji: foto_quiz,
    color: capa_quiz,
    difficulty: 'Difícil',
    duration: '5-10 min',
  ...
  },
  {
    ...
    fullDescription:
      'Monte o quebra-cabeça relacionado à Bacia Ceara-mirím, aprendendo sobre seus elementos enquanto se diverte.',
    emoji: foto_qc,
  ...
  },
  {
    ...
    fullDescription:
      'Conecte os canos corretamente para garantir que a água flua do ponto de origem até o destino final, evitando vazamentos e desperdícios.',
    emoji: pipeconect,
    color: capa_cano,
    difficulty: 'Fácil',
    duration: '3-5 min',
